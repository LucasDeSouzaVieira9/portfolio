...
import 'package:portfolio/feature/projects/firebase/feature/storage/storage_screen_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<StorageScreenCubit, StorageScreenState>(
      ...
      listener: (context, state) {
        state.maybeWhen(
          deleteSuccess: (image) => images.removeWhere((value) => image == value),
      ...
      builder: (context, state) => Scaffold(
        ...
        body: BlocConsumer<StorageScreenCubit, StorageScreenState>(
          ...
          builder: (context, state) => state.maybeMap(
            loading: (value) => const Center(child: CircularProgressIndicator(color: Color(0xffFFCB2B))),
            orElse: () => Padding(
                padding: const EdgeInsets.all(16),
                child: GridView.builder(
                  gridDelegate:
                      const SliverGridDelegateWithMaxCrossAxisExtent(maxCrossAxisExtent: 300, childAspectRatio: 2, mainAxisSpacing: 15, crossAxisSpacing: 15),
                  itemBuilder: (context, index) => Stack(
                    children: [
                      ...
                      InkWell(
                        onTap: () => cubit.deleteImage(images[index], user!.uid),
                        child: Padding(
