...
class _$_ImageModel extends _ImageModel {
  _$_ImageModel({required this.path, required this.url}) : super._();
  ...
  @override
  String toString() {
    return 'ImageModel(path: $path, url: $url)';
  }
...
abstract class _ImageModel extends ImageModel {
  factory _ImageModel({required final String path, required final String url}) =
      _$_ImageModel;
