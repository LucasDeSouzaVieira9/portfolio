...
import 'package:portfolio/feature/firebase/core/utils.dart';
import 'package:portfolio/feature/firebase/feature/login_screen/login_screen_cubit.dart';
                          ...
                          onPressed: () {
                            if (state is! LoginScreenLoadingState) {
                              if (_formKey.currentState!.validate()) {
                                cubit.login(_controllerEmail.text,
        ...
        decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderSide: const BorderSide(
                  color: Color.fromARGB(255, 28, 27, 27), width: 3.0),
