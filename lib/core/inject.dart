...
Future<void> setupInjection() async {
  ...
  inject.registerSingleton<GlobalKey<NavigatorState>>(GlobalKey<NavigatorState>(), instanceName: "navigator_settings");

  inject.registerSingleton<GlobalKey<NavigatorState>>(GlobalKey<NavigatorState>(), instanceName: "global");
